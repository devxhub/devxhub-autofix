...
class CommandSelector(object):
    ...
    def __init__(self, commands):
        """:type commands: Iterable[devxhub.types.CorrectedCommand]"""
    ...
    @property
    def value(self):
        """:rtype devxhub.types.CorrectedCommand"""
...
def select_command(corrected_commands):
    ...
    :type corrected_commands: Iterable[devxhub.types.CorrectedCommand]
    :rtype: devxhub.types.CorrectedCommand | None

    """
    try:
        selector = CommandSelector(corrected_commands)
    except NoRuleMatched:
        logs.failed('No dxhs given' if get_alias() == 'dxh'
                    else 'Nothing found')
        return
