...
The following commands are bundled with _The Dxh_, but are not enabled by
default:
...
-   `DEVXHUB_NUM_CLOSE_MATCHES` &ndash; the maximum number of close matches to suggest, like `5`.
