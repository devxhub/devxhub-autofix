...
If you have any issue with The Dxh, sorry about that, but we will do what we
...
-   the output of `devxhub --version` (something like `The Dxh 3.1 using
Python 3.5.0`);
-   your shell and its version (`bash`, `zsh`, _Windows PowerShell_, etc.);
-   your system (Debian 7, ArchLinux, Windows, etc.);
-   how to reproduce the bug;
-   the output of The Dxh with `DEVXHUB_DEBUG=true` exported (typically execute
    `export DEVXHUB_DEBUG=true` in your shell before The Dxh);
...
repository](https://github.com/devxhubcom/devxhub-autofix) for new rules, new features, bug
fixes, etc.
...
Install `The Dxh` for development:
