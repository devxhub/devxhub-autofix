...
from devxhub import corrector, const
from devxhub.system import Path
from devxhub.types import Command
from devxhub.corrector import get_corrected_commands, organize_commands


@pytest.fixture
def glob(mocker):
    results = {}
    mocker.patch('devxhub.system.Path.glob',
...
class TestGetRules(object):
    ...
    def load_source(self, monkeypatch):
        monkeypatch.setattr('devxhub.types.load_source',
                            lambda x, _: Rule(x))
...
def test_get_corrected_commands(mocker):
    ...
    rules = [Rule(match=lambda _: False),
             ...
             Rule(match=lambda _: True,
                  ...
                  priority=60)]
    mocker.patch('devxhub.corrector.get_rules', return_value=rules)
