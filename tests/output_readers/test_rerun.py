...
from devxhub.output_readers import rerun


class TestRerun(object):
    def setup_method(self, test_method):
        self.patcher = patch('devxhub.output_readers.rerun.Process')
    ...
    @patch('devxhub.output_readers.rerun._wait_output', return_value=False)
    @patch('devxhub.output_readers.rerun.Popen')
    ...
    @patch('devxhub.output_readers.rerun._wait_output')
    ...
    @patch('devxhub.output_readers.rerun._kill_process')
    ...
    @patch('devxhub.output_readers.rerun.logs')
